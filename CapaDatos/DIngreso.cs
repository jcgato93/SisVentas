    ...
    public class DIngreso
    {
        ...
        public string Insertar(DIngreso Ingreso,List<DDetalle_Ingreso > Detalle)
        {
            ...
            try
            {
                ...
                ParIdingreso.Direction = ParameterDirection.Output;//se utiliza este metodo por que es un valor de salida
