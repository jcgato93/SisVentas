...
namespace CapaPresentacion
{
    public partial class frmTrabajador : Form
    {
        ...
        public frmTrabajador()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtUsuario, "Ingrese el Usuario con el que el Trabajador accedera al Sistema");
            this.ttMensaje.SetToolTip(this.txtPassword, "Ingrese la Contraseña con la que el Trabajador accedera al Sistema ");
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.dtFechaNac.Value = Convert.ToDateTime(this.dataListado.CurrentRow.Cells["fecha_nac"]);
