...
namespace CapaPresentacion
{
    public partial class frmCliente : Form
    {
        ...
        public frmCliente()
        {
            ...
            this.ttMensaje.SetToolTip(txtNum_Documento, "Ingrese el Numero de Documento del cliente");
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.dtFechaNac.Value = Convert.ToDateTime(this.dataListado.CurrentRow.Cells["fecha_nacimiento"]);
